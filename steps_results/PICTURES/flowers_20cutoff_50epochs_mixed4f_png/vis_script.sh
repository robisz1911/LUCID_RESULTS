...
mkdir flowers_20cutoff_50epochs_mixed4f_png
cp merge.py flowers_20cutoff_50epochs_mixed4f_png/merge.py
...
do
    ...
    cat googlenet-node-names | grep Mixed_4f_Branch_3_b_1x1_act/Relu | python vis.py flowers_20cutoff_50epochs/$i.pb - $i
    mv $i.png flowers_20cutoff_50epochs_mixed4f_png
...
cd flowers_20cutoff_50epochs_mixed4f_png
python merge.py

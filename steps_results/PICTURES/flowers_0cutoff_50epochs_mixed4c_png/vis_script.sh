...
mkdir pictures_101_mixed4c
cp merge.py pictures_101_mixed4c/merge.py
...
do
    ...
    cat googlenet-node-names | grep Mixed_4c_Branch_3_b_1x1_act/Relu | python vis.py training_x/$i.pb - $i
    mv $i.png pictures_101_mixed4c
